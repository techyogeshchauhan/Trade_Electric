        ...
        <div class="login-card">
            ...
            <form id="loginForm">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" placeholder="Enter your name" class="form-control" id="loginIdInput"
                        required>
                    <div class="hint-text"><i class="fas fa-info-circle"></i> Your registered name is your Login ID
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <div class="hint-text"><i class="fas fa-info-circle"></i> Your registered mobile number is your
                        Password</div>
                </div>
